...
GRAPHS = [('DIbinary', 'accuracy'), ('sex-TPR', 'sex-calibration-'),
          ('SG:race-accuracy', 'accuracy'),
          ('SG:sex-accuracy', 'accuracy'),
          ('SG:race-sex-accuracy', 'accuracy'),
          ('SG:sex-TPR', 'sex-TPR'),
          ('SG:race-sex-TPR', 'race-sex-TPR'),
          ('SG:race-TNR', 'race-TNR'),
          ('SG:sex-TNR', 'sex-TNR'),
          ('SG:race-sex-TNR', 'race-sex-TNR'),
          ('SG:race-BCR', 'race-BCR'),
          ('SG:sex-BCR', 'sex-BCR'),
          ('SG:race-sex-BCR', 'race-sex-BCR'),
          ('SG:race-MCC', 'race-MCC'),
          ('SG:sex-MCC', 'sex-MCC'),
          ('SG:race-sex-MCC', 'race-sex-MCC'),
          ('SG:race-DIbinary', 'race-DIbinary'),
          ('SG:sex-DIbinary', 'sex-DIbinary'),
          ('SG:race-sex-DIbinary', 'race-sex-DIbinary'),
          ('SG:race-DIavgall', 'race-DIavgall'),
          ('SG:sex-DIavgall', 'sex-DIavgall'),
          ('SG:race-sex-DIavgall', 'race-sex-DIavgall'),
          ('SG:race-CV', 'race-CV'),
          ('SG:sex-CV', 'sex-CV'),
          ('SG:sex-calibration-', 'sex-calibration-'),
          ('SG:race-calibration-', 'race-calibration-'),
          ('SG:sex-race-calibration-', 'sex-race-calibration-'),
          ('SG:sex-calibration+', 'sex-calibration+'),
          ('SG:race-calibration+', 'race-calibration+'),
          ('SG:sex-race-calibration+', 'sex-race-calibration+')]
# GRAPHS = 'all'
